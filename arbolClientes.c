...
void preOrdenClientes(nodoArbol* arbol){
    if(arbol){
        muestraNodoArbolClientes(arbol);
        preOrdenClientes(arbol->izq);
        preOrdenClientes(arbol->der);
    }
}

void postOrdenClientes(nodoArbol* arbol){
    if(arbol){
        postOrdenClientes(arbol->izq);
        postOrdenClientes(arbol->der);
        muestraNodoArbolClientes(arbol);
    }
}
...
//MUESTRA UN CLIENTE DEL ARBOL, SEGUN ID PASADO POR PARAMETRO
void muestraUnClienteId(nodoArbol* arbol, int id){
    muestraNodoArbolClientes(buscaNodoArbolClientePorId(arbol, id));
    }

///.....................................FUNCIONES PARA ELIMINAR NODO DEL ARBOL................................................
///...........................................................................................................................

//ELIMINA ARBOL COMPLETO

nodoArbol* eliminarArbol(nodoArbol* arbol){
    nodoArbol* seg = arbol;
    if(seg){
        eliminarArbol(seg->izq);
        eliminarArbol(seg->der);
        borrarLista(seg->consumos);
        free(seg);
        seg = NULL;
    }
    return seg;
